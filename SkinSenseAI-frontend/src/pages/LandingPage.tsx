          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Learn about common skin concerns with AI-powered educational
                support. This tool provides information, not medical diagnosis.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Clear, educational information to help you understand your skin
              health
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div className="bg-blue-50 rounded-2xl p-8 border-2 border-blue-100">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-gray-700">
                  <span>
                    <strong>Educational Insights:</strong> Access clear
                    information about common skin conditions and wellness.
                  </span>
                </li>
                <li className="flex items-start gap-3 text-gray-700">
                  <span>
                    <strong>Early Awareness:</strong> Identify potential
                    concerns and understand when to prioritize a professional
                    visit.
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border-2 border-gray-200">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-gray-700">
                  <span>
                    <strong>Consultation Aid:</strong> Designed to support, not
                    replace, the clinical judgment of a healthcare provider.
                  </span>
                </li>
                <li className="flex items-start gap-3 text-gray-700">
                  <span>
                    <strong>Educational Screening:</strong> Our AI identifies
                    patterns for awareness; final diagnoses are made only by
                    medical experts.
                  </span>
                </li>
              </ul>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 leading-relaxed">
            This is an educational tool only. If you have any concerns about
            your skin health, please consult with a qualified healthcare
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2 rounded-full transition-all shadow-md hover:shadow-lg"
      >
        Sign Up
      </button>
    </div>
